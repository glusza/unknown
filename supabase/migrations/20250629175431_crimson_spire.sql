/*
  # Update Track Statistics Schema

  1. Schema Updates
    - Remove spotify_streams column from tracks table
    - Add in_app_streams_count for internal play tracking
    - Add reviews_data JSONB array to store all reviews and ratings
    - Keep spotify_url for external linking

  2. Functions
    - Create update_track_statistics() function to maintain track stats
    - Create increment_track_streams() function for play count tracking

  3. Triggers
    - Add trigger to update track statistics when ratings are added/updated
*/
